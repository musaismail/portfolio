...
const Home = () => {
  return (
    ...
    <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
      ...
      <h1 className='text-4xl font-bold sm:text-7xl text-[#ccd6f6]'>Ismail Musa</h1>
      <h2 className='text-4xl font-bold sm:text-7xl text-[#8892b0]'>I'm a Frontend Developer. </h2>
